...
import org.canteen_water.model.DataSource;
import org.canteen_water.model.User;
import org.canteen_water.model.api.ApiDataSource;
...
public class MainFXApplication extends Application {
    ...
    public Parent loadView(String name, Consumer<Object> controllerConsumer) {
        URL path = getClass().getResource("/org/canteen_water/view/" + name + "View.fxml");
